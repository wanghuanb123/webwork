    ...
    <script language="JavaScript">
        window.addEventListener('load',function (ev) {
            ...
            eye.addEventListener('click',function () {
                ...
                if (type === 'password'){
                    ima.src="/img/openpwd.png";
                }else{
                    ima.src="/img/closepwd.png";
                }
            })
        })
    </script>
...
<div class="main-body">
    <div class="login-main">
        ...
        <form class="layui-form login-bottom" method="post" action="/OFM/page/admin/login.do">
            <div class="center">
                <div class="item">
                    <span class="icon icon-2"></span>
                    <input type="text" name="adminName" lay-verify="required"  placeholder="请输入登录账号" maxlength="24"/>
                </div>

                <div class="item">
                    <span class="icon icon-3"></span>
                    <input type="password" name="adminPassword" lay-verify="required"  placeholder="请输入密码" maxlength="20">
                    <a href="#" id="passwordeye1">
                </div>
            ...
            <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                <a href="page/admin/toregister.do">
                    若没有账号请点击这里
                </a>
